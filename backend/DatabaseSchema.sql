...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260523174622_InitialCreate') THEN
...
BEGIN
    ...
    CREATE TABLE "AspNetUsers" (
        ...
        "FullName" text,
        "SuperuserNotes" text,
        "RequiresPasswordChange" boolean NOT NULL,
...
BEGIN
    ...
    CREATE TABLE "Projects" (
        ...
        "Contractor" text,
        "Consultants" text,
        "ContractCost" numeric(18,2) NOT NULL,
        "TotalAmountPaid" numeric(18,2) NOT NULL,
        "TSCost" numeric(18,2) NOT NULL,
        "AACost" numeric(18,2) NOT NULL,
        "PCICost" numeric(18,2) NOT NULL,
        "RevisedCost" numeric(18,2) NOT NULL,
        "CreatedAt" timestamp with time zone NOT NULL,
...
BEGIN
    ...
    CREATE TABLE "ProjectComments" (
        ...
        CONSTRAINT "FK_ProjectComments_AspNetUsers_UserId" FOREIGN KEY ("UserId") REFERENCES "AspNetUsers" ("Id") ON DELETE RESTRICT,
...
BEGIN
    ...
    VALUES ('20260523174622_InitialCreate', '8.0.5');
    END IF;
END $EF$;
COMMIT;
